...
class OnStepConfigurator:
    ...
    def fetch_from_github(self):
        ...
        repo_name = "onstep-configs"  # Replace with your repo name
...
def main():
    root = tk.Tk()
    root.iconbitmap(r"C:\Users\Royce Meredith\Documents\Python projects\Onstep Configurator\telescope.ico")
